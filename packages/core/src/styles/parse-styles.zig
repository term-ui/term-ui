...
pub fn parseStyleProperty(style: *Style, _key: []const u8, _value: []const u8) void {
    const key = trim(_key);
    ...
    if (std.mem.eql(u8, key, "display")) {
        ...
        style.flex_direction = parsed.value;
        ...
        style.background_color = parsed.value;
        ...
        style.font_weight = parsed.value;
        ...
        style.text_decoration = parsed.value;
        ...
        style.border_style = parsed.value;
        ...
        style.border_color.left = parsed.value;
...
pub fn parseStyleString(tree: *Tree, node_id: Node.NodeId, styles: []const u8) !void {
    ...
    while (iter_properties.next()) |_property| {
        ...
        // value = trim(value);
        parseStyleProperty(&tree.getNode(node_id).styles, key, value);
